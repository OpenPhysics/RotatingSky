...
export class StringManager {
  ...
  public getScreenNames(): {
    readonly horizonSystemStringProperty: ReadOnlyProperty<string>;
    readonly celestialSphereStringProperty: ReadOnlyProperty<string>;
    readonly explorerStringProperty: ReadOnlyProperty<string>;
  } {
    return {
      horizonSystemStringProperty: stringProperties.screens.horizonSystemStringProperty,
      celestialSphereStringProperty: stringProperties.screens.celestialSphereStringProperty,
      explorerStringProperty: stringProperties.screens.explorerStringProperty,
    };
  }
   ...
   */
  public getHorizonSystemA11yStrings() {
    return stringProperties.a11y.horizonSystem;
  }

  public getCelestialSphereA11yStrings() {
    return stringProperties.a11y.celestialSphere;
  }

  public getExplorerA11yStrings() {
    return stringProperties.a11y.explorer;
  }

  /**
   * Visible labels for the shared sky controls (latitude, add star, trails,
   * bands, the RA/Dec readout, …), used across all three screens.
   */
  public getControls() {
