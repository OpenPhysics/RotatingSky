/**
 * HorizonSystemKeyboardHelpContent.ts
 *
 * Keyboard Shortcuts dialog for the Horizon System screen. Sky-camera and star
 * rows come from RotatingSkyHotkeyData so icons stay in sync with the listeners.
 */
