...
const REPLACEMENTS: ReadonlyArray<[string, string]> = [
  ...
  ["RotatingSkyScreenSummaryContent", `${newPrefix}ScreenSummaryContent`],
  ["RotatingSkyKeyboardHelpContent", `${newPrefix}KeyboardHelpContent`],
  ["RotatingSkyPreferencesModel", `${newPrefix}PreferencesModel`],
  ["RotatingSkyPreferencesNode", `${newPrefix}PreferencesNode`],
  ["RotatingSkyScreenView", `${newPrefix}ScreenView`],
  ["RotatingSkyColors", `${newPrefix}Colors`],
  ["RotatingSkyNamespace", `${newPrefix}Namespace`],
  ["RotatingSkyScreen", `${newPrefix}Screen`],
  ["RotatingSkyModel", `${newPrefix}Model`],
  // camelCase identifier
  ["rotatingSkyQueryParameters", `${newCamel}QueryParameters`],
  // Display strings
  ["Rotating Sky", newName],
  // Kebab identifiers (path segments and package name)
  ["rotating-sky", newId],
  ["rotating-sky-screen", `${newId}-screen`],
];
...
console.log(`  id:     rotating-sky → ${newId}`);
console.log(`  name:   Rotating Sky → ${newName}`);
